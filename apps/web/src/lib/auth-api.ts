...
// POST /auth/forgot-password (backlog_password-management.md Step 3, task 3.6). The API
// answers with the same generic message whether or not the email is registered.
...
// POST /auth/reset-password (task 3.6). The API logs out every session for the account on
// success, so any access token stored in this browser is cleared too.
