...
- `pnpm --filter api exec prisma generate` — regenerate the Prisma client from `schema.prisma` (no real DB needed for this one; `migrate`/`db seed` wait on 1.4)
